...
import {club_join_controller , create_message_controller , delete_messages_controller, get_message_controller} from '../controllers/userControllers.js';
...
userRouter.post('/get-messages' , verifyToken , get_message_controller);
